...
public class Kamikaze implements Ball, Animated{
	float x, y;
	int color;
	...
	Ball hitThis;
	public Kamikaze(World w, float x, float y, Ball targetBall) {
		this.world = w;
	...
	public Kamikaze(World w, float x, float y) {
		this.world = w;
		this.color = w.getColor(0, 0, 255);
		this.radius = 12;
		this.x = x;
	...
	public void update(){
		if(!world.getAllBalls().contains(hitThis)){
